...
(function(){
  ...
  app.controller('newsController', [ '$http', '$scope', '$rootScope', function($http, $scope, $rootScope){
    ...
    $scope.yourAPI = 'http://lafabulosafm.com/api/get_recent_posts/';
    $scope.items = [];
    $scope.totalPages = 0;
    $scope.currentPage = 1;
    $scope.pageNumber = 1;
  ...
  app.controller('radioController', function($scope, $sce, ngAudio){
    ...
    $scope.radioHost = 'http://lafabulosafm.com'; // Replace this with your own radio stream URL
    $scope.radioPort = '8100'; // Replace this with the port of your Radio Stream
    ...
    $.SHOUTcast({
       host : 'lafabulosafm.com', // Replace this with your own radio stream URL but remove the http
